...
gulp.task('build-sass', () => {
	return gulp.src('./src/assets/sass/style.sass').pipe(sass().on('error', sass.logError)).pipe(gulp.dest(dist)).pipe(browsersync.stream())
})
...
gulp.task('watch', () => {
	...
	gulp.watch('./src/assets/sass/**/*.sass', gulp.parallel('build-sass'))
